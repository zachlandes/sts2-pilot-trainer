...
/// The enemy measurement alone is null on the turn this side's fight was lost, whose
/// killing step left nothing of the enemy in the reading after it. Everything else
/// is a number the trace sampled either side of an action.
/// </summary>
public sealed record FightResultPoint(
    int Turn,
    /// <summary>Enemy health that actually came off this turn, or null where this
    /// side did not reach the turn or lost the fight on it. Damage a block absorbed
