...
The relics page first and the deck takes what is left, because the relics stand over the strip and the deck under it; every pane is held to its height, the opened run's included, because at the holder's own size a mid-act run's relics and an ordinary deck ran past the panel's ribbon.
