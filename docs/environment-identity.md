...
The renamed Runmobile artifact is wired to the same API, and what its own retail session does and does not establish is [in-game-host.md](in-game-host.md)'s to say.
