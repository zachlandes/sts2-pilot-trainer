...
A survival seed of the fifth stage's kind, or the retail soak, is what retires those; a walk into a second act is built and held (`WalkPolicy.AskInTheNextAct`), and waits on a seed that survives the first.
