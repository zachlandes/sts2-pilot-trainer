...
The first build queued that notice from the teardown as well, and a player who saved and quit a replayed fight came back to the menu to a popup about a comparison they had not asked for.
