...
**What CI cannot run is recorded by name.** On a runner without the game, 132 of
`Sts2PilotTrainer.Arbiter.Tests`' 182 tests skip and the job still reports success.
