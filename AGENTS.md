...
What no generated walk reaches is what the headless host has no screen for and the undo of an ended turn, which needs the window the retail client leaves open before the enemy turn.
