...
The step that ends a fight the run survives is read once the engine has settled, through the pump, because the game rolls the rewards after the killing action finishes and a reading taken before that names a state no save and no replay ever holds.
